  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className="flex items-center justify-between gap-2 h-9 px-3 bg-white border border-[#400404]/20 hover:border-[#400404] rounded-xl text-xs font-medium text-[#400404] transition-all focus:outline-none focus:ring-1 focus:ring-[#400404]/20 shrink-0 w-32 cursor-pointer shadow-xs"
        >
