  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className="relative w-9 h-9 flex items-center justify-center text-[#400404] hover:bg-[#400404]/10 rounded-full transition-colors cursor-pointer focus:outline-none shrink-0"
          title="Notificações"
        >
          <Bell className="w-5 h-5 text-[#400404] shrink-0" />
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 w-4 h-4 bg-[#400404] text-[#FFFBED] text-[10px] font-bold rounded-full flex items-center justify-center shadow-xs">
